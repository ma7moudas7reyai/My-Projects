...
print("Load Dataset: \n")
trainingData = pd.read_csv("C:\\Users\\zas\\OneDrive\\سطح المكتب\\University\\2- Semester 2\\Machine Learning\\Project\\Machine Project\\Mobiles Dataset (2025).csv", encoding = 'latin1')
